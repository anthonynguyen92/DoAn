...
import { StudentDto } from './service/modules/student-dto';
import { StudentDtoPagedResultDto } from './service/modules/student-dto-paged-result-dto';
...
export class StudentService {
    ...
    createStudent(body:StudentDto | undefined):Observable<StudentDto>{
        let url_ = this.baseUrl + "/api/services/app/Student/Create";
        ...
        return this.http.post(url_,content,option).pipe(_observableMergeMap((response_: any) => {
            return this.processCreate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
    ...
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined)
        : Observable<StudentDtoPagedResultDto> {
