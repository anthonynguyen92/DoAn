...
import { StudentDto } from '../modules/student-dto';
import { StudentDtoPagedResultDto } from '../modules/student-dto-paged-result-dto';
...
export class StudentService {
    ...
    create(body: StudentDto | undefined): Observable<StudentDto> {
        let url_ = this.baseUrl + "api/service/app/Student/create";
        url_ = url_.replace(/[?%]$/, "");
        ...
        return this.http.request("post", url_, option_).pipe(_observableMergeMap((response_: any) => {
    ...
    update(body: StudentDto | undefined): Observable<StudentDto> {
        let url = this.baseUrl + "/api/services/app/Student/Update";
        ...
        return this.http.request("put", url, options_).pipe(_observableMergeMap((response_: any) => {
    ...
    delete(id: string | undefined): Observable<void> {
        let url = this.baseUrl + "/api/services/app/Student/Delete?";
        if (id === null)
        ...
        return this.http.request("delete", url, options_).pipe(_observableMergeMap((response_: any) => {
    ...
    get(id:string| undefined):Observable<StudentDto>{
