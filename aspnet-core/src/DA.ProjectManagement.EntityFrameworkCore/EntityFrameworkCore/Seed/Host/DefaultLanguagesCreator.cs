...
namespace DA.ProjectManagement.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = ProjectManagementConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
