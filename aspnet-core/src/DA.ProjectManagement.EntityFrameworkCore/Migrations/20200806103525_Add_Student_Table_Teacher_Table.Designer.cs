...
namespace DA.ProjectManagement.Migrations
{
    ...
    [Migration("20200806103525_Add_Student_Table_Teacher_Table")]
    partial class Add_Student_Table_Teacher_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DA.ProjectManagement.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DA.ProjectManagement.Teachers.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("DA.ProjectManagement.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("DA.ProjectManagement.Authorization.Users.User", null)
                        .WithMany("Claims")
